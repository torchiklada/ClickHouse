...
SELECT number FROM numbers(10) LIMIT 0 - 1; -- { serverError 321 }
SELECT number FROM numbers(10) LIMIT 1.0;
SELECT number FROM numbers(10) LIMIT 1.5; -- { serverError 321 }
...
SELECT * FROM numbers(10) LIMIT 0.33 / 0.165 - 0.33 + 0.67; -- { serverError 321 }
